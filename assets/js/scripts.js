...
$(document).ready(function () {
  ...
  $(document).ready(function () {
    ...
    const scrollActive = () => {
      ...
      sections.each(function () {
        ...
        const sectionTop = $this.offset().top - 58;
        const sectionId = $this.attr("id");
        const $sectionLink = $(`.nav-menu a[href*="${sectionId}"]`);
  ...
  $(document).ready(function () {
    $(".nav-link").on("click", function () {
      const offcanvas = $("#navContentmenu").get(0);
  ...
  var incrementPlus = buttonPlus.click(function () {
    var $n = $(this).parent(".ticket-amounts").find(".input-number");
  ...
  $("input:radio:checked")
    .parent()
    .addClass("radio-checked-bg border-transparent");
  $("input:radio").click(function () {
    $("input:not(:checked)")
      .parent()
      .removeClass("radio-checked-bg border-transparent");
